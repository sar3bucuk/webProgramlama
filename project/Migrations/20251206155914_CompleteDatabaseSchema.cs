        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Gyms_Time", "[OpeningTime] < [ClosingTime]");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Members_Height", "[Height] > 0");
                    table.CheckConstraint("CK_Members_Weight", "[Weight] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Trainers_Experience", "[ExperienceYears] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AIRecommendations_RequestType", "[RequestType] IN ('ExercisePlan', 'DietPlan', 'BodyTransformation')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GymServices_Duration", "[Duration] > 0");
                    table.CheckConstraint("CK_GymServices_Price", "[Price] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TrainerAvailability_DayOfWeek", "[DayOfWeek] >= 0 AND [DayOfWeek] <= 6");
                    table.CheckConstraint("CK_TrainerAvailability_Time", "[StartTime] < [EndTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Appointments_Duration", "[Duration] > 0");
                    table.CheckConstraint("CK_Appointments_Price", "[Price] >= 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GymServices_GymId_ServiceId",
                table: "GymServices",
                columns: new[] { "GymId", "ServiceId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerSpecializations_TrainerId_Specialization",
                table: "TrainerSpecializations",
                columns: new[] { "TrainerId", "Specialization" },
                unique: true);
        }
