...
namespace proje.Migrations
{
    ...
    [Migration("20251220120200_AddMessageFieldsToNotification")]
    partial class AddMessageFieldsToNotification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("proje.Models.Message", b =>
                {
                    ...
                    b.Property<string>("ReceiverAdminUserId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ReceiverMemberId")
                        .HasColumnType("int");

                    b.Property<int?>("ReceiverTrainerId")
                        .HasColumnType("int");

                    b.Property<int?>("ReplyToMessageId")
                        .HasColumnType("int");

                    b.Property<string>("SenderAdminUserId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("SenderMemberId")
                        .HasColumnType("int");

                    b.Property<int?>("SenderTrainerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReceiverTrainerId");

                    b.HasIndex("ReplyToMessageId");

                    b.HasIndex("SenderMemberId");

                    b.HasIndex("SenderTrainerId");

                    b.ToTable("Messages", t =>
                        {
                            t.HasCheckConstraint("CK_Messages_Receiver", "([ReceiverMemberId] IS NOT NULL AND [ReceiverTrainerId] IS NULL) OR ([ReceiverMemberId] IS NULL AND [ReceiverTrainerId] IS NOT NULL)");

                            t.HasCheckConstraint("CK_Messages_Sender", "([SenderMemberId] IS NOT NULL AND [SenderTrainerId] IS NULL) OR ([SenderMemberId] IS NULL AND [SenderTrainerId] IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("proje.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("proje.Models.NutritionPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("DailyCarbohydrate")
                        .HasPrecision(6, 2)
            ...
            modelBuilder.Entity("proje.Models.Message", b =>
                {
                    b.HasOne("proje.Models.Member", "ReceiverMember")
                        .WithMany()
                        .HasForeignKey("ReceiverMemberId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("proje.Models.Trainer", "ReceiverTrainer")
                        .WithMany()
                        .HasForeignKey("ReceiverTrainerId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("proje.Models.Message", "ReplyToMessage")
                        .WithMany()
                        .HasForeignKey("ReplyToMessageId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("proje.Models.Member", "SenderMember")
                        .WithMany()
                        .HasForeignKey("SenderMemberId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("proje.Models.Trainer", "SenderTrainer")
                        .WithMany()
                        .HasForeignKey("SenderTrainerId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("ReceiverMember");

                    b.Navigation("ReceiverTrainer");

                    b.Navigation("ReplyToMessage");

                    b.Navigation("SenderMember");

                    b.Navigation("SenderTrainer");
                });
